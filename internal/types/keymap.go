...
func DefaultKeyMap() KeyMap {
	return KeyMap{
		...
		CommitSubmit:  key.NewBinding(key.WithKeys("alt+s"), key.WithHelp("alt+s", "submit commit")),
		AmendCommit:   key.NewBinding(key.WithKeys("alt+a"), key.WithHelp("alt+a", "amend")),
		CommitAndPush: key.NewBinding(key.WithKeys("alt+p"), key.WithHelp("alt+p", "commit & push")),
